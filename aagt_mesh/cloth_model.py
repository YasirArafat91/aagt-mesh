...
from aagt_mesh import common
from aagt_mesh import core_model
from aagt_mesh import normalization
...
class Model(snt.AbstractModule):
  ...
  def _build_graph(self, inputs, is_training):
    ...
    return core_model.MultiGraph(
        ...
        edge_sets=[mesh_edges],  positions=inputs['mesh_pos'])

  def _build(self, inputs):
    graph = self._build_graph(inputs, is_training=False)
    per_node_network_output = self._learned_model(graph, is_training=False)
